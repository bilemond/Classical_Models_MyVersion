...
if __name__ == '__main__':
    ...
    parser.add_argument("--pipeline_name", type=str, default="train_vit")
    parser.add_argument("--model_name", type=str, default="SimpleViT")
    # Training settings
    ...
    trainset = torchvision.datasets.CIFAR10(root="../dataset/cifar10", train=True, download=True, transform=trans_train)
